...
pub enum DefType {
  /// Builtin definition.
  Builtin,
  /// Definition that was generated by the compiler.
  Generated,
  /// Definition with its source code location.
  Normal(usize, usize),
  /// Definition imported from another package.
  Import,
  /// Definition imported from another package,
  /// but unable to be named by the source of the current book.
  Inaccessible,
}
...
impl Definition {
  pub fn new(name: Name, rules: Vec<Rule>, def_type: DefType) -> Self {
    Self { name, rules, def_type }
  }

  pub fn new_gen(name: Name, rules: Vec<Rule>, builtin: bool) -> Self {
    let def_type = if builtin { DefType::Builtin } else { DefType::Generated };
    Self { name, rules, def_type }
  }

  pub fn is_builtin(&self) -> bool {
    matches!(self.def_type, DefType::Builtin)
  }
